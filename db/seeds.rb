...
tracker = Tracker.new(category_id: Category.fifth.id, treatment_id: treatment.id, rating: '6', notes: 'seeing progress', created_at: "2021-06-04")
tracker.save!

tracker = Tracker.new(category_id: Category.fifth.id, treatment_id: treatment.id, rating: '8', notes: 'seeing progress', created_at: "2021-06-06")
tracker.save!
